...
describe('sessionsToCsv', () => {
  ...
  const sessions: Session[] = [
    { id: '2', activityId: 'a', start: at(14), end: null, note: '', tags: [] },
    {
      id: '1',
      activityId: 'a',
      start: at(9),
  ...
  it('writes a header and one row per session, oldest first, in local time', () => {
    ...
    expect(csv.slice(1).split('\r\n')).toEqual([
      'date,start,end,duration_minutes,activity,note,tags',
      '2026-09-11,09:00:00,10:30:00,90.00,Deep work,"Plan, v2",q3 client-a',
